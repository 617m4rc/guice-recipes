...
public abstract class AnnotationMemberProviderSupport<A extends Annotation> implements AnnotationMemberProvider<A> {
	...
	public Object provide(A annotation, TypeLiteral<?> type, Method method, Class<?> parameterType, int parameterIndex) {
	...
	protected abstract Object provide(A annotation, Member member, TypeLiteral<?> requiredType, Class<?> memberType, Annotation[] annotations);
}
